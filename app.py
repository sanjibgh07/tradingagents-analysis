...
st.markdown('''
<style>
.stApp{background:radial-gradient(circle at 8% 0%,rgba(125,92,255,.20),transparent 30%),radial-gradient(circle at 92% 8%,rgba(0,210,190,.14),transparent 28%),#090b12;color:#f3f5fa}
.block-container{max-width:1320px;padding-top:1.35rem;padding-bottom:4rem}
.hero{padding:1.7rem 1.9rem 1.8rem;border:1px solid rgba(145,125,255,.24);border-radius:1.3rem;background:linear-gradient(135deg,rgba(25,23,50,.98),rgba(13,16,27,.97));box-shadow:0 20px 60px rgba(0,0,0,.34);margin-bottom:1.25rem}
.eyebrow,.section-label{color:#b8aaff}.eyebrow{font-size:.78rem;letter-spacing:.14em;text-transform:uppercase;opacity:.9;font-weight:750}.hero-title{font-size:clamp(2rem,4vw,3.25rem);line-height:1.05;font-weight:850;margin:.35rem 0 .6rem}.hero-copy{font-size:1rem;color:#b7bdca;max-width:820px;line-height:1.6}.status-row{display:flex;gap:.55rem;flex-wrap:wrap;margin-top:1rem}.status-pill{padding:.42rem .72rem;border-radius:999px;background:rgba(125,92,255,.10);border:1px solid rgba(155,135,255,.20);font-size:.78rem;color:#d9d5ff}.dot{width:7px;height:7px;border-radius:50%;background:#36d9a0;display:inline-block;box-shadow:0 0 10px rgba(54,217,160,.65)}
.nav-card{padding:1rem 1.1rem;border-radius:1rem;border:1px solid rgba(145,125,255,.22);background:linear-gradient(135deg,rgba(24,24,42,.92),rgba(13,16,27,.90));margin-bottom:1.2rem}.nav-title{font-size:.72rem;text-transform:uppercase;letter-spacing:.14em;color:#9d91d9;font-weight:800;margin-bottom:.45rem}.nav-caption{font-size:.78rem;color:#858c9d;margin-top:.45rem}
.section-label{font-size:.78rem;text-transform:uppercase;letter-spacing:.12em;font-weight:800;opacity:.9;margin:.25rem 0 .65rem}.decision-card{padding:1.25rem 1.4rem;border-radius:1rem;border:1px solid rgba(145,125,255,.22);background:linear-gradient(135deg,rgba(38,31,72,.55),rgba(13,20,35,.72));margin:.8rem 0 1.25rem}.decision-caption{font-size:.78rem;text-transform:uppercase;letter-spacing:.12em;color:#b8aaff;opacity:.9;font-weight:750}.decision-value{font-size:2.4rem;font-weight:850;margin-top:.2rem}.decision-meta{opacity:.62;font-size:.86rem;margin-top:.15rem}
div[data-testid="stVerticalBlockBorderWrapper"]{border-radius:1rem;border-color:rgba(145,125,255,.18);background:rgba(16,18,29,.55)}div.stButton>button{border-radius:.72rem;min-height:2.7rem;font-weight:750;border-color:rgba(145,125,255,.28);background:#171527;color:#f5f2ff}div.stButton>button:hover{transform:translateY(-1px);border-color:#9d8aff;background:#211d38}.stSelectbox>div>div{border-radius:.72rem;border-color:rgba(145,125,255,.28)}div[data-baseweb="select"]>div{background:#11131d;border-color:rgba(145,125,255,.30);color:#f3f5fa}.stSlider [data-baseweb="slider"]{color:#9d8aff}.footer{text-align:center;opacity:.45;font-size:.75rem;padding-top:1.5rem}
...
st.markdown('<div class="nav-card"><div class="nav-title">Workspace navigation</div>',unsafe_allow_html=True)
